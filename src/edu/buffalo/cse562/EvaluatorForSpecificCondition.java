...
public class EvaluatorForSpecificCondition implements ExpressionVisitor{
	...
	public EvaluatorForSpecificCondition(Column[] schema) {
	...
	public void visit(Function arg0) {
		...
		if (funName.equalsIgnoreCase("date"))
		{
			...
			Datum tempDate = new Datum.DatumDate(dateStr);
			//String dateStr = arg0.getParameters().getExpressions().get(0);
			if(date1 != null){
				date2 = tempDate;
			}else{
				date1 = tempDate;
	...
	public void visit(AndExpression arg0) {
		...
		if(dateCount == 2 && argCol.equals("reciptdate") || argCol.equals("orderdate")){
			dates = new DatumDate[2];
			dates[0] = (DatumDate)date1;
			dates[1] = (DatumDate)date2;
			dateCount = 0;
			tableName = argTable.getName();
		}		
	}
